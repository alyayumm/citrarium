...
export const educationSections: InfoSection[] = [
  ...
  { id: 'teachers', slug: 'pedagogicheskiy-sostav', title: 'Педагогический состав', shortTitle: 'Педагогический состав', icon: 'certificate', itemProp: 'employees', summary: 'Карточки педагогических работников будут заполнены после подтверждения персональных данных.', table: { caption: 'Поля для карточек педагогических работников', columns: ['Сведения', 'Статус'], rows: [['ФИО', 'будет добавлено'], ['Должность', 'будет добавлено'], ['Уровень образования', 'будет добавлено'], ['Квалификация', 'будет добавлено'], ['Стаж работы', 'будет добавлено']] }, documents: doc('teacher-ethics') },
  ...
  { id: 'support', slug: 'stipendii-i-mery-podderzhki', title: 'Стипендии и меры поддержки', shortTitle: 'Поддержка', icon: 'support', itemProp: 'grants', summary: 'Сведения о стипендиях, мерах поддержки и общежитии.', fields: [{ label: 'Меры поддержки', value: '[Будет уточнено перед публикацией]', itemProp: 'grant' }], documents: doc('ovz-education', 'ovz-responsible-order') },
  ...
  { id: 'standards', slug: 'obrazovatelnye-standarty-i-trebovaniya', title: 'Образовательные стандарты', shortTitle: 'Стандарты', icon: 'shield', itemProp: 'eduStandarts', summary: 'Сведения о федеральных государственных образовательных стандартах и требованиях.', fields: [{ label: 'Стандарты и требования', value: '[Будет уточнено перед публикацией]', itemProp: 'eduFedDoc' }], documents: doc('assessment-conditions-control', 'current-control', 'final-attestation') },
  { id: 'accessible', slug: 'dostupnaya-sreda', title: 'Доступная среда', shortTitle: 'Доступная среда', icon: 'unlock', itemProp: 'ovz', summary: 'Сведения о специальных условиях для инвалидов и лиц с ОВЗ.', fields: [{ label: 'Специальные условия', value: '[Будет заполнено после подтверждения доступности объекта]', itemProp: 'ovz' }], documents: doc('accessibility-passport', 'ovz-education', 'ovz-responsible-order') },
];
